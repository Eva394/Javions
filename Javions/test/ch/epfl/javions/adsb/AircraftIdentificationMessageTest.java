...
class AircraftIdentificationMessageTest {
    ...
    void aircraftIdentificationMessageCategoryWorksForKnownMessages() {
        ...
        var messagesAndCategories = List.of( new MessageAndCategory( "8D3950D1200464B8D10360A58DCD", 0xa0 ),
    ...
    void aircraftIdentificationMessageCallSignWorksForKnownMessages() {
        ...
        var messagesAndCallSigns = List.of( new MessageAndCallSign( "8D3991E1230464B1CD4320FCD23B", "AFR13TL" ),
        ...
        for ( var messageAndCallSign : messagesAndCallSigns ) {
            ...
            var aircraftIdentificationMessage = AircraftIdentificationMessage.of( rawMessage );
            assertNotNull( aircraftIdentificationMessage );
            assertEquals( callSign, aircraftIdentificationMessage.callSign()
                                                                 .string() );
        }
    }
    ...
    void aircraftIdentificationMessageOfReturnsNullForInvalidCharacters() {
        var invalidMessages = List.of( "8D3944EF200464B2DD8440F1ADDC", "8D3944EF200464B2DD86E0EB71AC",
                                       "8D3944EF200464B2DDC4608CE47E", "8D3944EF200464B275846031B6E0",
                                       "8D3944EF2004649EDD84607FE1EE", "8D3944EF200467F2DD84600A4B89",
                                       "8D3944EF200614B2DD84607692E1", "8D3944EF208864B2DD84601C3BFD",
                                       "8D3944EF200464B2DD84630F847E", "8D3944EF200464B2DD8920B5B88C",
                                       "8D3944EF200464B2DE5460835099", "8D3944EF200464B29984604DC53A",
                                       "8D3944EF200464A7DD8460CBAD58", "8D3944EF20046A32DD8460E381DF",
                                       "8D3944EF200694B2DD84600C01E8", "8D3944EF20A864B2DD8460B84D24",
                                       "8D3944EF200464B2DD846B0FF412", "8D3944EF200464B2DD8B20A9A38C",
                                       "8D3944EF200464B2DED4607A40BD", "8D3944EF200464B2B9846008B913",
                                       "8D3944EF200464AFDD84606BB3C9", "8D3944EF20046EB2DD8460EE2F80",
                                       "8D3944EF2007B4B2DD8460987E3A", "8D3944EF20F064B2DD8460F47543",
                                       "8D3944EF200464B2DD847D0F30E7", "8D3944EF200464B2DD8FA096934C",
                                       "8D3944EF200464B2DFF46049D0F5" );
        for ( var message : invalidMessages ) {
            var rawMessage = RawMessage.of( 100, HexFormat.of()
                                                          .parseHex( message ) );
            assertNotNull( rawMessage );
            var aircraftIdentificationMessage = AircraftIdentificationMessage.of( rawMessage );
