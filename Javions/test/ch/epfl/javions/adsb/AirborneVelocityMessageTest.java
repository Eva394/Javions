...
class AirborneVelocityMessageTest {
    ...
    String messageWithNewPayload(String baseMessage, long newPayload) {
        ...
        var newMessageBytesNoCrc = HexFormat.of()
                                            .parseHex( newMessageStringNoCrc );
    ...
    void airborneVelocityMessageOfReturnsNullWhenSubtypeIsInvalid() {
        var invalidMessages = List.of( "8D3C4DC8988CA882E0A409EC0FAE", "8D3C4DC89D8CA882E0A409BE7697",
                                       "8D3C4DC89E8CA882E0A409250D87", "8D3C4DC89F8CA882E0A409F97770" );
    ...
    void airborneVelocityMessageOfReturnsNullWhenGroundSpeedIsUnknown() {
        ...
        for ( String message : messages ) {
            var messageBytesWithVns0 = HexFormat.of()
                                                .parseHex( message );
    ...
    void airborneVelocityMessageOfWorksWithSubtypes1And2() {
        ...
        var messageBytesA = HexFormat.of()
        ...
        var messages = List.of( new MessageAndSpeedAndTrack( "8D3C4DC8998CA882E0A409307559", 86.654498, 4.581407 ),
        ...
        for ( MessageAndSpeedAndTrack messageAndSpeedAndTrack : messages ) {
            var messageBytes = HexFormat.of()
                                        .parseHex( messageAndSpeedAndTrack.message() );
            var rawMessage = RawMessage.of( 0L, messageBytes );
            assertNotNull( rawMessage );
        ...
        var supersonicMessageBytes = HexFormat.of()
                                              .parseHex( supersonicMessage );
    ...
    void airborneVelocityMessageOfWorksWithSubtypes3And4() {
        // Messages B from:
        // https://mode-s.org/decode/content/ads-b/5-airborne-velocity.html
        var messageBytesB = HexFormat.of()
                                     .parseHex( "8DA05F219B06B6AF189400CBC33F" );
