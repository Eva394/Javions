...
public enum AircraftIcon {
    ...
    public static AircraftIcon iconFor(AircraftTypeDesignator typeDesignator, AircraftDescription typeDescription,
                                       int category, WakeTurbulenceCategory wakeTurbulenceCategory) {
        var maybeDesignatorIcon = TYPE_DESIGNATOR_TABLE.get( typeDesignator );
        if ( maybeDesignatorIcon != null ) {
            return maybeDesignatorIcon;
        }
        ...
        var maybeDescriptionIcon = switch ( description ) {
            ...
            case "L4T" -> HEAVY_4E;
            case "L4J" -> wakeTurbulenceCategory == HEAVY
                          ? HEAVY_4E
                          : null;
            default -> null;
        };

        if ( maybeDescriptionIcon != null ) {
            return maybeDescriptionIcon;
        }
