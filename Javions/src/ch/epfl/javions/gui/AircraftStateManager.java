...
public final class AircraftStateManager {
	...
	public void purge() {
		...
		receivedStates.entrySet()
		              .removeIf( state -> lastUpdatedTimeStampNs - ONE_MINUTE_IN_NANOSECONDS > state.getValue()
		                                                                                            .stateSetter()
		                                                                                            .getLastMessageTimeStampNs() );
	}
}
