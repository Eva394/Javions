...
public final class AircraftController {
    ...
    private void createLabelGroup( Group iconAndLabelGroup, ObservableAircraftState addedAircraft ) {
        ...
        String aircraftID = addedAircraft.getAircraftData() != null && addedAircraft.getAircraftData()
                ...
                .registration()
                .string()
                : ( addedAircraft.getCallSign() != null ? addedAircraft.getCallSign()
                .string()
    ...
    private void createIcon( Group iconAndLabelGroup, ObservableAircraftState addedAircraft, AircraftData data ) {
        ...
        AircraftTypeDesignator typeDesignator = dataIsNull ? new AircraftTypeDesignator( "" ) : data.typeDesignator();
        AircraftDescription description = dataIsNull ? new AircraftDescription( "" ) : data.description();
        WakeTurbulenceCategory wakeTurbulenceCategory = dataIsNull ? WakeTurbulenceCategory.UNKNOWN
        ...
        iconPath.rotateProperty()
                .bind( addedAircraft.trackOrHeadingProperty()
                        .map( trackOrHeading -> icon.canRotate() ? ( Units.convertTo(
                                addedAircraft.trackOrHeadingProperty()
                                        .get(), Units.Angle.DEGREE ) ) : 0 ) );
